...
class Migration(migrations.Migration):
    ...
    def delete_reference_to_cpes_with_empty_urls(apps, _):
        ...
        https://github.com/aboutcode-org/vulnerablecode/issues/818#issuecomment-1206437637
        """
        Reference = apps.get_model("vulnerabilities", "VulnerabilityReference")
        Reference.objects.filter(
            reference_id__startswith="cpe", url="").delete()

    operations = [
        migrations.RunPython(
            delete_reference_to_cpes_with_empty_urls, migrations.RunPython.noop),
    ]
