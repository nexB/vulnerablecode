...
from vulnerabilities.importers.gsd import get_cvss_str_v_cve_org
...
class TestGSDImporter(TestCase):
    ...
    def test_get_references(self):
        ...
        ) == [Reference(url="https://kc.mcafee.com/corporate/index?page=content&id=SB10198")]
